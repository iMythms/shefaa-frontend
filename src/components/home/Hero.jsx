...
const Hero = () => {
	return (
		<section className="bg-[#2A3342] rounded-b-[64px] mb-48">
			<div className="pt-76 pb-48 container mx-auto grid grid-cols-2 gap-32">
				<div className="flex flex-col gap-6">
					...
					<h1 className="font-extrabold text-4xl text-white leading-normal text-balance">
						Your Health and Wellbeing, our Priority
					</h1>
					<p className="text-base font-normal text-[#8896AB] text-balance">
